  ...
  container.innerHTML = recurringRules.map((rule, idx) => `
    <div class="recurring-item">
      ...
      <div class="recurring-meta">
        ...
        <span class="category-badge" style="background: var(--accent-light); padding: 2px 10px; border-radius: 20px;">${escapeHtml(rule.category)}</span>
      </div>
...
function showRecurringModal(editIndex = -1) {
  ...
  Swal.fire({
    ...
    html: `
      ...
      <input id="recDesc" placeholder="বিবরণ (যেমন: বিদ্যুৎ বিল)" value="${rule ? escapeHtml(rule.description) : ''}" style="width:100%; margin-bottom:12px; padding:12px; border-radius:16px;">
