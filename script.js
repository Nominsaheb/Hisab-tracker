    ...
    const html = `
        <div class="card">
            ...
            <div style="display:flex; gap:15px; margin-top:20px;">
                <button class="btn-gradient-warning" id="addRecurringBtn" style="flex:1;"><i class="fas fa-plus-circle"></i> + নতুন নিয়ম</button>
...
function renderSavingsPage() {
    ...
    const html = `
        ...
        <button class="btn-gradient-gold" onclick="addSavingsGoal()"><i class="fas fa-plus-circle"></i> নতুন সঞ্চয় লক্ষ্য</button>
    `;
